...
contract ERC1155Test is DSTestPlus, ERC1155TokenReceiver {
    ...
    function setUp() public {
        token = ERC1155(yulDeployer.deployContract("ERC1155", "1234567890123456790123456790123456790123456790123456790"));
    }

    function testLongUri() public {
        assertEq(token.uri(0), "1234567890123456790123456790123456790123456790123456790");
    }

    function testShortUri() public {
        ERC1155 token1 = ERC1155(yulDeployer.deployContract("ERC1155", "123"));
        assertEq(token1.uri(0), "123");
    }
